...
<ul class="listagem">
  ...
  <li>Coordenar as ofertas educacionais direcionadas aos trabalhadores da saúde, apoiar a rede <a class = "ref" alt ="" target ="_blank"  href=https://www.unasus.gov.br/>UNA-SUS</a>, disponibilizar recursos educacionais para seu acervo e contribuir com a oferta de cursos para qualificação dos trabalhadores do SUS.</li>
</ul>

<p>Os cursos de Graduação e Pós-Graduação, na modalidade à distância, ofertados pela UFES, atualmente em parceria com a <a  class = "ref" alt ="" target ="_blank" href=http://portal.mec.gov.br/politica-de-educacao-inclusiva?id=12265>Universidade Aberta do Brasil – UAB</a> e a <a  class = "ref" alt ="" target ="_blank" href=https://universidades.es.gov.br/polos-unac>Universidade Aberta Capixaba - UnAC</a> estão presentes em todas as macrorregiões e microrregiões do estado do Espírito Santo. Nelas, a UFES oferta vagas, em cursos semipresenciais, desenvolvidos nos polos UAB instalados nos seguintes municípios:</p>
...
<p>Não é à toa que as agendas globais e acordos internacionais ressaltam a importância da educação como política estratégica e poder transformador para o desenvolvimento justo, igualitário e sustentável. Melhorar, independentemente da modalidade utilizada, é um dos objetivos da Educação no âmbito dos <a class = "ref" alt ="" target ="_blank"  href=https://www.unicef.org/brazil/objetivos-de-desenvolvimento-sustentavel>Objetivos do Desenvolvimento Sustentável (ODS)</a> e da <a class = "ref" alt ="" target ="_blank"  href=https://brasil.un.org/pt-br/91863-agenda-2030-para-o-desenvolvimento-sustent%C3%A1vel>Agenda 2030</a>. Considerando esses fatos, importa olhar também para o cenário interno, onde a eficiência operacional é um dispositivo que deve ser considerado para alcançar a excelência
...
<p>Com isso, recentemente, a SEAD/UFES integrou-se ao <a class = "ref" alt ="" target ="_blank"  href=https://universidades.es.gov.br/>Sistema Universidade do Espírito Santo - UniversidadES</a>, programa do governo do estado, administrado pela <a class = "ref" alt ="" target ="_blank"  href=https://secti.es.gov.br/>Secretaria da Ciência, Tecnologia, Inovação e Educação Profissional - Secti</a>, participando da <a class = "ref" alt ="" target ="_blank"  href=https://universidades.es.gov.br/polos-unac>Universidade Aberta Capixaba (UnAC)</a>, em regime de colaboração, para oferecer cursos superiores nas diferentes áreas do conhecimento; e ampliar o acesso à educação superior pública no Estado. </p>
...
<p>Fonte: <a  class = "ref" alt ="" target ="_blank"  href=https://abed.org.br/arquivos/CENSO_EAD_2020_PORTUGUES.pdf>Censo EAD.BR - Relatório Analítico da Aprendizagem a Distância no Brasil 2020-2021</a></p>
