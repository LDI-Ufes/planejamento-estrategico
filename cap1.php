...
<p>Portanto, já que as mudanças são inevitáveis, é preciso transformar o modo de pensar, agir e interagir internamente na UFES. A introdução da modalidade a distância na estrutura presencial de ensino (Ensino Híbrido) exige alterações referentes à Normatização, Formação de Recursos Humanos; Estrutura Organizacional; Oferta de Cursos; e Tecnologia, em função das características diferenciadas da educação à distância. Diversas Instituições de Ensino Superior, de variados portes, como, por exemplo, a <a class = "ref" alt ="" target ="_blank"   href=https://www.ufrgs.br/sead/>Universidade Federal do Rio Grande - FURG</a>, a <a class = "ref" alt ="" target ="_blank"   href=https://netel.ufabc.edu.br/>Universidade Federal do ABC - UFABC</a>, a <a  class = "ref" alt ="" target ="_blank"  href=https://nead.ufersa.edu.br/?_ga=2.187970349.409320247.1679323531-1234228539.1679323531&_gl=1*6t0yxa*_ga*MTIzNDIyODUzOS4xNjc5MzIzNTMx*_ga_K0YZPWHKKC*MTY3OTMyMzUzMS4xLjEuMTY3OTMyMzYxNi4wLjAuMA..>Universidade Federal Rural do Semiárido - UFERSA</a>, a <a  class = "ref" alt ="" target ="_blank"  href=https://www.unifesp.br/reitoria/sead/>Universidade Federal De São Paulo - UNIFESP</a>, a <a  class = "ref" alt ="" target ="_blank"  href=https://www.cead.unb.br/>Universidade de Brasília - UNB</a>, a <a class = "ref" alt ="" target ="_blank"   href=https://cesad.ufs.br/>Universidade Federal de Sergipe - UFS</a>, a <a class = "ref" alt ="" target ="_blank"   href=https://cipead.ufpr.br/portal1/>Universidade Federal do Paraná - UFPR</a> e a <a  class = "ref" alt ="" target ="_blank"  href=http://cead.ufpi.br/>Universidade Federal do Piauí - UFPI</a> já estão em fase bastante avançada nesse processo de
...
geral da instituição. O termo “institucionalização” que normalmente é utilizado para se referenciar a um modelo de fomento (VIEIRA et al., 2012) deverá evoluir, no meio acadêmico, para indicar o processo de implantação e maturidade da EAD (FERREIRA & CARNEIRO, 2015; PESCE, 2007; SILVA & SILVA, 2012). As previsões de novos cursos, tanto numa modalidade como na outra, farão parte das estratégias de desenvolvimento do ensino superior da Universidade. No <a  class = "ref" alt ="" target ="_blank"  href=https://avaliacaoinstitucional.ufes.br/sites/avaliacaoinstitucional.ufes.br/files/field/anexo/PPI-UFES.pdf>PPI</a> e <a class = "ref" alt ="" target ="_blank"   href=https://proplan.ufes.br/sites/proplan.ufes.br/files/field/anexo/pdi_2021-2030.pdf>PDI</a>, as estratégias de novos cursos serão definidas, o que criará indicadores de despesas para os exercícios financeiros. </p>
...
papaia, abacaxi, maracujá, coco, goiaba e morango).</td>
  ...
  <figcaption>
  Fonte: <a class = "ref" alt ="" target ="_blank"  href=https://www.es.gov.br>https://www.es.gov.br/</a>
  </figcaption>
</figure>
...
<tr>
  ...
  <figcaption>
    Fonte: <a  class = "ref" alt ="" target ="_blank" href=https://www.ibge.gov.br>https://www.ibge.gov.br/</a> e <a class = "ref" alt ="" target ="_blank"  href=https://www.gov.br/sudene/pt-br>https://www.gov.br/sudene/pt-br</a>
  </figcaption>
</figure>
...
<ul class="listagem">
  ...
  <li><strong><a class = "ref" alt ="" target ="_blank"  href=https://techinnovations.info/why-every-organization-needs-an-augmented-reality-strategy/?gclid=Cj0KCQiAgOefBhDgARIsAMhqXA4-St4ZlhKLzFNWjBNZNmNd_gzOKl-Xug8iH_io3QPTKI1W-ecvHHYaAqAKEALw_wcB>VR e AR</a>:</strong> Construindo nosso admirável novo mundo virtual.</li>
...
<p>Fonte: <a class = "ref" alt ="" target ="_blank"  href=https://faithpopcorn.com>https://faithpopcorn.com</a></p>
